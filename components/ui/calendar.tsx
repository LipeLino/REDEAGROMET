    ...
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          ...
          "[&:has([aria-selected].day-range-start)]:bg-primary [&:has([aria-selected].day-range-end)]:bg-primary",
        ...
        day: cn(
          ...
          "data-[outside=true]:hover:bg-transparent data-[outside=true]:cursor-default"
        ),
